...
export const CovidCard: React.FC<CovidCardProps> = (props) => {
  ...
  return (
    <div className="flex flex-col justify-between w-full min-h-full overflow-hidden ">
      <div className="flex flex-col flex-grow-0 p-2 h-2/3 justify-evenly">
      ...
      <div className="flex flex-row items-center justify-between flex-grow p-2 px-3 bg-gray-300 rounded-none h-1/3">
