...
export const ItemAge: React.FC<CardGroupItem> = (props) => {
  ...
  props.completed &&
    (statusStyles +=
      'shadow-inner text-blue-600 hover:bg-blue-100 cursor-pointer ');
  return (
    <div
      className={
        'px-4 bg-white shadow-lg rounded-xl bg-gray-200' + statusStyles
      }
    >
      ...
      <div
        className={
          'font-sans text-base text-gray-800 font-semibold text-blue-600'
        }
      >
        {props.risk}
      </div>
