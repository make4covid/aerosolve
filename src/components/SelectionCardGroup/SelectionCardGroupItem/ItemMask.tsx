...
export const ItemMask: React.FC<CardGroupItem> = (props) => {
    ...
    return (
        <div className={"px-4 bg-white shadow-lg rounded-xl bg-gray-200"}>
            <div className={"font-sans py-0 text-lg text-gray-800 font-semibold" }>{props.title}</div>
            <div className={"font-sans py-0 text-lg text-gray-800 font-semibold" }>{props.description}</div>
