...
export const SidebarGroupItem: React.FC<NavGroupItem> = (props) => {
    ...
    return (
        <div onClick={(e)=>{// @ts-ignore
            props.handleChange(props.value)}}  style={props.style} className={"font-sans font-normal relative flex flex-row items-center justify-between px-2 py-1 bg-white transition duration-200 border-t" + statusStyles}>
