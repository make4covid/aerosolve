...
import {PhysicalActivity,PhysicalActivityProps} from "./PhysicalActivity";
...
const Template: Story<PhysicalActivityProps> = (args) => <PhysicalActivity {...args} />;
...
Activity.args = {
    ...
    description:"Challenging physical activity increases breathing rates, which means more aerosols are reletion"
}
