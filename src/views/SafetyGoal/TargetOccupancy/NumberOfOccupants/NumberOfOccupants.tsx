...
import { OccupantsCard, OccupantsCardProps } from 'components/OccupantsCard/OccupantsCard'
  ...
  return (
    <div className="relative w-full h-full bg-gray-300 rounded-xl">
      <div className="grid grid-cols-3">
        <div className="col-span-1 pl-10 text-lg font-semibold text-gray-700">
          <p>Number of Occupants</p>
          {nOfOccupant.map((value, index) => {
            if (value === 0) {
              return (
                <span className="inline-block p-1">
                  <img className="px-1" src={head_white} alt="" />
                  <img src={body_white} alt="" />
                </span>
              )
            } else {
              return (
                <span className="inline-block p-1">
                  <img className="px-1" src={head_blue} alt="" />
                  <img src={body_blue} alt="" />
                </span>
              )
            }
          })}
        ...
        <div className="relative col-span-1 pr-10">
          <p className="text-base font-medium">
            Target number of occupants intended for the space to be occupied in a single setting.
          </p>
