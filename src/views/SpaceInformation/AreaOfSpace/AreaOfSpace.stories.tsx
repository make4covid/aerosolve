...
import {AreaOfSpace,AreaOfSpaceProps} from "./AreaOfSpace";
import {PageHeaderProps} from "components/PageHeader/PageHeader";

export default {
    title: 'Aerosolve/Views/SpaceInformation/AreOfSpace',
    component: AreaOfSpace
}

const Template: Story<AreaOfSpaceProps> = (args) => <AreaOfSpace {...args} />;
